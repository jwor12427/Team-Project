<?php
    ...
    $memberSql = "SELECT * FROM myAdminMember";
...
<body>
            ...
            <div class="join__inner">
                <form action="adminJoinSave.php" name="join" method="post" onsubmit="return joinChecks()"
                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            <div>
                                <div class="joinProfile_inner">
                                    <div class="joinProfile_name">프로필</div>
                                    <div class="PrivacyImg">
                                        <img id="preview-image"
                                            src="../assets/img/member/<?php if($memberInfo['youImgFile']==''){ echo "Img_default.jpg";}else{echo $memberInfo['youImgFile'];}; ?>"
                                            alt="프로필 이미지">
                                        <p class="blind">이미지를<br>등록해 주세요</p>
                                    </div>
                                    <label for="youFile" class="joinProfile_label">+</label>
                                    <input type="file" name="youFile" id="youFile" accept=".jpg, .jpeg, .png, .gif"
                                        placeholder="jpg, gif, png 파일만 넣어주세요" style="opacity: 1;">
                                </div>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="password" id="youPassC" name="youPassC" placeholder="비밀번호를 한번 더 입력하세요."
                                    required>
    ...
    const inputImage = document.getElementById("youFile")
